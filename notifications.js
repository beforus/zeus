...
$('#navigation').append('' +
                        '<li>'+
                                    ...
                                    '<li>'+
                                       '<div class="media">'+
                                            '<img class="d-flex align-self-center img-radius" src="includes\assets\images\avatar-4.jpg" alt="Generic placeholder image">
                                    ...
                                    '<li>'+
                                        '<div class="media">'+
                                            '<img class="d-flex align-self-center img-radius" src="includes\assets\images\avatar-3.jpg" alt="Generic placeholder image">
                                            '<div class="media-body">'+
    ...
    '<ul class="pcoded-item pcoded-left-item">' +
        ...
        '</li>' +
       '<li class="">' +
           '<a href="https://github.com/users/plaidraid/projects/4/views/1">' +
   ...
   '<ul class="pcoded-item pcoded-left-item">' +
       ...
       '<li class=" ">' +
           '<a href="keyboard.htm">' +
               '<span class="pcoded-micon"><i class="feather icon-cpu"></i></span>' +
               '<span class="pcoded-mtext">Keyboard</span>' +
           '</a>' +
       '</li>' +
       '<li class="pcoded-hasmenu">' +
           '<a href="javascript:void(0)">' +
   ...
   '<ul class="pcoded-item pcoded-left-item">' +
       ...
       '</li>' +
   '</ul>' +
   '<div class="pcoded-navigatio-lavel">Location</div>' +
   '<ul class="pcoded-item pcoded-left-item">' +
       '<li class="pcoded-hasmenu">' +
           '<ul class="pcoded-submenu">' +
               '<li class=" ">' +
                   '<a href="bs-basic-table.htm">' +
                       '<span class="pcoded-mtext">Time</span>' +
                   '</a>' +
               '</li>' +
               '<li class=" ">' +
                   '<a href="bs-table-sizing.htm">' +
                       '<span class="pcoded-mtext">Compass</span>' +
                   '</a>' +
               '</li>' +
               '<li class=" ">' +
   ...
   '<ul class="pcoded-item pcoded-left-item">' +
       ...
       '</li>' +
       '<li class="">' +
           '<a href="includes\extra-pages\landingpage\index.htm" target="_blank">' +
       ...
       '<li class="pcoded-hasmenu ">' +
           ...
           '<ul class="pcoded-submenu">' +
               ...
               '<li class="pcoded-hasmenu ">' +
                   ...
                   '<ul class="pcoded-submenu">' +
                       '<li class="">' +
                           '<a href="includes\extra-pages\email-templates\email-welcome.htm">' +
                               '<span class="pcoded-mtext">Welcome Email</span>' +
                           '</a>' +
                       '</li>' +
                       '<li class="">' +
                           '<a href="includes\extra-pages\email-templates\email-password.htm">' +
                               '<span class="pcoded-mtext">Reset Password</span>' +
                           '</a>' +
                       '</li>' +
                       '<li class="">' +
                           '<a href="includes\extra-pages\email-templates\email-newsletter.htm">' +
                               '<span class="pcoded-mtext">Newsletter Email</span>' +
                           '</a>' +
                       '</li>' +
                       '<li class="">' +
                           '<a href="includes\extra-pages\email-templates\email-launch.htm">' +
                               '<span class="pcoded-mtext">App Launch</span>' +
                           '</a>' +
                       '</li>' +
                       '<li class="">' +
                           '<a href="includes\extra-pages\email-templates\email-activation.htm">' +
